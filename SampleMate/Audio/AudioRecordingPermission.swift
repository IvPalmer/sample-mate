// Checks/requests the system "audio capture" (TCC) permission required for process taps.
// Ported from Guilherme Rambo's AudioCap (https://github.com/insidegui/AudioCap).
//
// Uses TCC SPI to preflight/request `kTCCServiceAudioCapture`. This is private API:
// fine for Developer ID / notarized distribution, but NOT allowed on the Mac App Store.
// If App Store distribution is ever wanted, gate this out and rely on the system prompt
// triggered by tap creation instead.
