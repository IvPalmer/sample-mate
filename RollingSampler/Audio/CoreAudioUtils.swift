// Core Audio property-reading helpers.
// Ported from Guilherme Rambo's AudioCap (https://github.com/insidegui/AudioCap), MIT-style sample code.
...
extension AudioObjectID {
    ...
    /// Reads `kAudioObjectPropertyName` (human-readable device name).
